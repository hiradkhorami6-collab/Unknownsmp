...
document.getElementById("joinForm")?.addEventListener("submit",async e=>{
  ...
  if(!String(data.telegram).trim()){msg.textContent="لطفاً آیدی تلگرام را وارد کنید.";return}
