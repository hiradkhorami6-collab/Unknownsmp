(() => {
  ...
  function renderTimer() {
    ...
    navTimer.textContent = `${faNumber(days)} روز ${String(hours).padStart(2,"0")}:${String(minutes).padStart(2,"0")}:${String(seconds).padStart(2,"0")}`;
  }
  ...
  if (skin) {
    skin.addEventListener("error", () => {
      skin.src = "https://mc-heads.net/avatar/ImHiradkh/120";
    }, { once: true });
  }
})();